...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('(\u001b[36m>\033[1;37m) Mau Berapa Target? : '))
	except ValueError:
		print('(\u001b[36m>\033[1;37m) Masukkan Angka Anjing, Malah Huruff ')
		exit()
	if jum<1 or jum>100:
		print('(\u001b[36m>\033[1;37m) Gagal Dump Idz ')
		exit()
	ses=requests.Session()
	yz = 0
	for met in range(jum):
		yz+=1
		kl = input('(\u001b[36m>\033[1;37m) Masukkan Idz Yang Ke '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
			...
			print('(\u001b[36m>\033[1;37m) Sinyal Loh Kek Kontoll ')
			exit()
	try:
		print('')
		print(f'(\u001b[36m>\033[1;37m) Total Idz Yang Terkumpul🔥{h}'+str(len(id)))
		pass__()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
		print('(\u001b[36m>\033[1;37m) Sinyal Lo kek Kontol ')
		back()
	except (KeyError,IOError):
		print(f'(\u001b[36m>\033[1;37m){k} Pertemanan Tidak Public {x}')
		time.sleep(3)
		back()
 #-------------[ ENTER FILE ]------------------#
def file_hal():
